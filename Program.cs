...

{
    class Program
    {
        public static List<string> invetory = new List<string>();  //  inventory
        public static List<string> LiVaru = new List<string>();   //  varukorg 
        ...
        static string Seleziona2(int sel)
        {
            ...
            Console.ForegroundColor = ConsoleColor.White;
            Console.SetCursorPosition(40, 3 + r++);
            Console.Write("                                      ");    // tar bort sista raden av inventory på console
